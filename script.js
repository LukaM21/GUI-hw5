/* 
File: script.js
This file is the one that handles the main game logic. It uses jQuery to manage the DOM and user interactions. 
It initializes the Scrabble board, tile rack, and scoreboard. The code allows players to drag and drop tiles onto the board, 
validate words using an external dictionary API, and keep track of scores. It also includes functionality to reset the game, 
clear the board, and draw new tiles. The game state is updated dynamically based on user actions, providing an interactive Scrabble experience.
*/
